...
public class Administrador extends Usuario {
	...
	public ArrayList<String> consultarOperacionesV2(Date fechaInicio,
			Date fechaFinal, Administrador administrador, String val2) throws Exception {

		ConectionMYSQLAdministradorDAO conection = new ConectionMYSQLAdministradorDAO();
		
		return conection.consultarOperacionesV2(fechaInicio.toString(), fechaFinal.toString(),  val2);
	}

	public ArrayList<String> consultarOperacionesV3(Date fechaInicio,
			Date fechaFinal, Administrador administrador, String val2) throws Exception {

		ConectionMYSQLAdministradorDAO conection = new ConectionMYSQLAdministradorDAO();
		
		return conection.consultarOperacionesV3(fechaInicio.toString(), fechaFinal.toString(),  val2);
	}
	
	public ArrayList<String> consultarConsignaciones(String monto) throws Exception {

		ConectionMYSQLAdministradorDAO conection = new ConectionMYSQLAdministradorDAO();
		
		return conection.consultarConsignaciones(monto);
	}
	...
	public ArrayList<String> consultarPunto(String punto1, String punto2) throws Exception {
		...
		return conection.consultarPunto(punto1, punto2);
	}
