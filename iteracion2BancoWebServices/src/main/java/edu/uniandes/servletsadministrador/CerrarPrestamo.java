...
/**
 * Servlet implementation class CerrarPrestamo
 */
public class CerrarPrestamo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			administrador.CerrarPrestamo(id);
			...
			out.println("<article>");
			out.println("<h2>" + "Se ha Cerrado la Cuenta con el ID: </h2>");
			out.println("<br>");
			out.println("<p>" + id + "</p>");
			out.println("<br>");
			out.println("</article>");
			...
			out.println("<section Class=\"articles\">");
			out.println("<article>");
			out.println("<h2> No Se Pudo Cerrar Pr&eacutestamo</h2>");
			out.println("<br>");
