 ...
 */
public class ConsultarOperacionesV3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarOperacionesV3() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<String> resp = administrador.consultarOperacionesV3(fechaInicio, fechaFinal, administrador, val2);
