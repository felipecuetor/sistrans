 ...
 */
public class RegistroPuntoDeAtencion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegistroPuntoDeAtencion() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String stringOficina = request.getParameter("oficina");
		...
		try {
			System.out.println("Pregunto por la oficina");
			Oficina oficina =  administrador.obtenerOficina(stringOficina);
			System.out.println("Tengo a la Oficina");
			PuntoDeAtencion nuevoPuntoDeAtencion= new PuntoDeAtencion(tipo, localizacion, oficina);
			administrador.registrarPuntoDeAtencion(nuevoPuntoDeAtencion);
			System.out.println("Agrego el punto de atencion");
			...
			out.println("<article>");
			out.println("<h2> Se ha registrado un nuevo punto de atenci&oacuten </h2>");
			out.println("<br>");
			out.println("<p> Oficina : "+ nuevoPuntoDeAtencion.getOficina().getGerente().getUsuario() + "</p>");
			out.println("<p> Tipo : "+ nuevoPuntoDeAtencion.getTipo() + "</p>");
			out.println("<p> localizaci&oacuten : "+ nuevoPuntoDeAtencion.getLocalizacion() + "</p>");
			out.println("<br>");
			out.println("</article>");
			out.println("</section>");
			out.println("</section>");
			...
			out.println("<section Class=\"articles\">");
			out.println("<article>");
			out.println("<h2> No se pudo registrar el Punto De Atenci&oacuten</h2>");
			out.println("<br>");
